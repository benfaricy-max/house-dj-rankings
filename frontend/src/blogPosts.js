...
export const BLOG_POSTS = [
  ...
  {
    slug: "rave-journey",
    title: "My Rave Journey: From the Drop to the Underground",
    dek: "Eight years, twenty-odd nights that mattered, and the slow slide from festival main stages to 6am techno.",
    date: "2026-06-03",
    author: "Ben Faricy",
    readMins: 9,
    blocks: [
      ...
      { type: "p", text: "What follows is the honest map of the eight years since — the nights that rewired me, and the slow, total slide from the biggest, brightest main stages to the smallest, darkest rooms. Looking back, the whole arc bends one direction: away from the drop, toward the underground." },
