// clubsData.js — pure data + ranking logic for the Club Index.
// Extracted from ClubsPage.jsx so backend/generatePages.js (Node) can prerender
// /club/<slug> pages from the SAME source of truth (no drift). No React/CSS deps.
