...
// ── Genre lean (house ↔ techno) — extracted to ./genre.js ────────────────────
// Moved to a plain-JS module so the build (backend/generatePages.js) and the SPA
// share ONE classifier (same single-source pattern as clubsData.js). Re-exported
// here so existing `import { genreLean, GENRE_META, matchesGenre } from "./methodology"` keeps working.
export { GENRE_META, genreLean, isPureTechno, matchesGenre } from "./genre.js";
